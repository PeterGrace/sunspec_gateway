...
YOU ARE A RABID DOCUMENTARIAN.  You will create markdown docs for every new iteration of code.  You will create these docs under changelog/ and will date-and-timestamp the markdown files.
