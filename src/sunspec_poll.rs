                ...
                Some(v) => {
                    match v.value {
                        ...
                        Some(val) => {
                            ...
                            let _ = tx.send(IPCMessage::Outbound(PublishMessage{ topic, payload })).await;
                        }
                    }
                }
            }
